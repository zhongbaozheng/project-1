Ext.ns('Ext.project');
Ext.project.TeamBuildPanel = new Ext.extend(Ext.Panel, {
    actionJson : null,
	constructor : function(config) {
        ...
        Ext.project.TeamBuildPanel.superclass.constructor.call(this,{
            layout : 'border',
	...
	showInsertWindow : function() {
		if (this.addTeamBuildWindow == null) {
			this.addTeamBuildWindow = new Ext.project.TeamBuildWindow({
				saveUrl : this.Url.insertUrl,
				store : this.store
			});
			this.addTeamBuildWindow.setTitle('新增方案');
		}
		this.addTeamBuildWindow.show();
		this.addTeamBuildWindow.reset();
	},
	/** 实现修改操作按钮功能 */
    showUpdateWindow : function() {
        ...
        if (this.updateTeamBuildWindow == null) {
            this.updateTeamBuildWindow = new Ext.project.TeamBuildWindow({
                saveUrl : this.Url.insertUrl,
                store : this.store
            });
            this.updateTeamBuildWindow.setTitle('修改方案');
        }
        this.updateTeamBuildWindow.show();
        this.updateTeamBuildWindow.reset();
        this.updateTeamBuildWindow.loadRecord(records[0]);
    }
